...
// RTC 获取视频流（屏幕录制或者摄像头） navigator.mediaDevices.getDisplayMedia  =>  需要混音则  MediaStream.addTrack() 将音频轨迹添加进去 
// =>  new MediaRecorder 用视频流获取bold => 将 bold 和 推流地址通过 socket 发送到流服务器（用 node.js + ffmpeg ） https://www.jb51.net/article/128471.htm